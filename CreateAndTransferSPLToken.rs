...
pub fn main()(spl_token_mint_token_b58: String, spl_token_mint_account_b58: String, cluster_url: String)  
    ...
    //Create a new Keypair for the wallet account
    ...
    let create_asso_acc_ix =  
                spl_associated_token_account::create_associated_token_account(&payer_pubkey, 
                &wallet_pubkey, &spl_token_mint_token_pubkey);
